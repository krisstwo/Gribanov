 ...
 */
final class Version20210510201226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__agent AS SELECT id, representative_id, territory FROM agent');
        ...
        $this->addSql('INSERT INTO agent (id, representative_id, territory) SELECT id, representative_id, territory FROM __temp__agent');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__manager AS SELECT id, representative_id, territory FROM manager');
        ...
        $this->addSql('INSERT INTO manager (id, representative_id, territory) SELECT id, representative_id, territory FROM __temp__manager');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__publicist AS SELECT id, representative_id, territory FROM publicist');
        ...
        $this->addSql('INSERT INTO publicist (id, representative_id, territory) SELECT id, representative_id, territory FROM __temp__publicist');
